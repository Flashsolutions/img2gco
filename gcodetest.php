...
if (isset($_FILES['image']['name']))
{
    ...
    switch($_FILES['image']['type'])
    {
        ...
        case "image/bmp": $src = imagecreatefromwbmp($_FILES['image']['tmp_name']); break;
...
print("\n;Created using Nebarnix's IMG2GCO program Ver 1.0 with modifications by Larry Fortna\n");
...
//print("G21\n");
//print("M42 P4 S$laserOff; Turn laser off\n");
//print("G1 F$feedRate\n");

$lineIndex=0;
print("G0 X$offsetX Y$offsetY F$travelRate\n");
//for($line=($sizeY+$offsetY); $line>0; $line-=$scanGap)
